        ...
        {success ? (
          ...
          <form onSubmit={handleActivate} className="space-y-6">
            ...
            <div className="text-center text-sm text-gray-600">
              <a href="/tenant/tea-boy/login" className="text-amber-600 hover:text-amber-700 font-medium">
